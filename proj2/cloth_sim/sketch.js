...
function preload() {
  ...
  clothTexture = loadImage('assets\\gto2.webp');
}
...
//   cleanupDetachedParticles() {
//     for (let i = 0; i < this.particles.length; i++) {
//         for (let j = 0; j < this.particles[i].length; j++) {
//             let particle = this.particles[i][j];
//             // Check if the particle is connected to any spring
//             let isConnected = false;
//             for (let spring of this.springs) {
//                 if (particle.isConnectedTo(spring)) {
//                     isConnected = true;
//                     break;
//                 }
//             }
//             // If not connected, mark it as null (or undefined) for removal
//             if (!isConnected) {
//                 this.particles[i][j] = null;
//             }
//         }
//         // Filter out the nulls (or undefined)
//         this.particles[i] = this.particles[i].filter(p => p !== null);
//     }
//     // Filter out any empty rows
//     this.particles = this.particles.filter(row => row.length > 0);
// }
