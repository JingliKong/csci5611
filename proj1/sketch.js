...
function preload() {
  ...
  venus = loadImage('images/planet2.png');
  jupiter = loadImage('images/jup.png');
  gotHit = loadImage('images/explosion.png');
  hitsound = loadSound('sounds/thunder.mp3');
  backgroundImg = loadImage('images/starry_sky.jpg');
}
function genBalls() {
  let ballSize = 20;
